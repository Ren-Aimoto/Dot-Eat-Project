...
public class GameManager : MonoBehaviour {
    ...
    private int CheatingScore = 200; //チートデイ発動条件
    private int ScoreForCheating = 0; //チートデイ発動可能かスコア格納用
    ...
    //タイトル画面でタイトル文字より遅れてボタンを出すInvoke用のメソッド
